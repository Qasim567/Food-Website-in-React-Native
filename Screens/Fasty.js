...
export default function Fasty(props){
    return(
        <View style={styles.container}>
            ...
            <View style={styles.view4}>
                <Image style={styles.img1} source={require('../assets/zinger.jpg')}
               resizeMode='contain'>
               </Image>
               <Image style={styles.img2} source={require('../assets/pizza.jpg')}
               resizeMode='contain'>
               </Image>
                </View>
                <View style={styles.view5}>
                    <Text style={styles.txt2}>Zinger Burger</Text>
                    <Text style={styles.txt9}>Pizza</Text>
                </View>
                ...
                <View style={styles.view7}>
                    ...
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Zinger Burger')}>
                ...
                <View style={styles.view4}>
                <Image style={styles.img1} source={require('../assets/roast.jpg')}
               resizeMode='contain'>
               </Image>
               <Image style={styles.img2} source={require('../assets/chapl.jpg')}
               resizeMode='contain'>
               </Image>
                </View>
                <View style={styles.view5}>
                    <Text style={styles.txt2}>Chicken Roast</Text>
                    <Text style={styles.txt10}>Chapli kbab</Text>
                </View>
                <View style={styles.view6}>
                ...
                <View style={styles.view7}>
                    ...
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Chicken Roast')}>
                        <Text style={styles.txt21}>+</Text>
                    </TouchableOpacity>
                    <Text style={styles.txt5}>$ 20</Text>
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Chapli Kbab')}>
                        <Text style={styles.txt21}>+</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.view4}>
                <Image style={styles.img1} source={require('../assets/pratha.jpg')}
               resizeMode='contain'>
               </Image>
               <Image style={styles.img2} source={require('../assets/sandwich.jpg')}
               resizeMode='contain'>
               </Image>
                </View>
                <View style={styles.view5}>
                    <Text style={styles.txt2}>Pratha Roll</Text>
                    <Text style={styles.txt11}>Chicken Sandwich</Text>
                </View>
                <View style={styles.view6}>
                ...
                <View style={styles.view7}>
                    ...
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Pratha Roll')}>
                        <Text style={styles.txt21}>+</Text>
                    </TouchableOpacity>
                    <Text style={styles.txt5}>$ 95</Text>
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Chicken Sandwich')}>
                        <Text style={styles.txt21}>+</Text>
                    </TouchableOpacity>
                </View>
                <View style={styles.view4}>
                <Image style={styles.img1} source={require('../assets/bun.jpg')}
               resizeMode='contain'>
               </Image>
               <Image style={styles.img2} source={require('../assets/fries.jpg')}
               resizeMode='contain'>
               </Image>
                </View>
                <View style={styles.view5}>
                    <Text style={styles.txt2}>Bun Kbab</Text>
                    <Text style={styles.txt12}>Fries</Text>
                </View>
                <View style={styles.view6}>
                ...
                <View style={styles.view7}>
                    ...
                    <TouchableOpacity style={styles.btntxt5}
                     onPress={()=>props.navigation.navigate('Bun Kbab')}>
                        <Text style={styles.txt21}>+</Text>
                    </TouchableOpacity>
