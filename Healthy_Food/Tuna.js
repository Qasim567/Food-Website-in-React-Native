...
export default function Tuna(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/tuna.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Tuna Casserole</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.2</Text>
            </View>
            </View>
