...
export default function Vege(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/veggie.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Grilled Veggies</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.5</Text>
            </View>
            </View>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$20</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
