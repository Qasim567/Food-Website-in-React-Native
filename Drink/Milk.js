...
export default function Milk(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/almond.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Almond Milk</Text>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$80</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
