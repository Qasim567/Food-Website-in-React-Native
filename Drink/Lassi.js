...
export default function Lassi(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/lassi.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Lassi</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.3</Text>
            </View>
            </View>
