...
export default function Zinger(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/zinger.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Zinger Burger</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>5.0</Text>
            </View>
            </View>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$55</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
