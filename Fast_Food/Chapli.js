...
export default function Chapli(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/chapl.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Chapli kbab</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.8</Text>
            </View>
            </View>
