...
export default function Fries(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/fries.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Fries</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.6</Text>
            </View>
            </View>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$95</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
