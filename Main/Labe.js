...
export default function Labe(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/labbe.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Lab-e-Shireen</Text>
            <View style={styles.view1a}>
                <Ionicons style={styles.ion}
                  name='star'/>
                <Text style={styles.txt2}>4.9</Text>
            </View>
            </View>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$50</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
