...
export default function Cocunut(props){
    return(
        <View style={styles.container}>
            <Image style={styles.img} source={require('../assets/cocunet.jpg')}
               resizeMode='stretch'>
               </Image> 
            <View style={styles.view1}>
                <Text style={styles.txt1}>Cocunut Ice Cream</Text>
            ...
            onPress={()=> props.navigation.navigate('Order Now')}>
                ...
                <Text style={styles.btntxt2}>$15</Text>
                </View>
            </TouchableOpacity>  
        </View>
        );
